...
{
    public class When_Testing_Adding_Commands_WithOptions_From_Type
    {
        ...
        public When_Testing_Adding_Commands_WithOptions_From_Type()
        {
    ...
    public class When_Testing_Adding_Commands_From_Type
    {
        public class TestCommands
        {
        ...
        public When_Testing_Adding_Commands_From_Type()
        {
            _rootcommand = new RootCommand()
        ...
        {
            var command = _rootcommand.GetSubCommand<TestCommands>(x => nameof(x.TestMethod3));
        ...
        {
            var command = _rootcommand.GetSubCommand<TestCommands>(x => nameof(x.TestMethod4));
            command.Should().BeNull();

            command = _rootcommand.GetSubCommand("Baz");
            command.Description.Should().Be(null);
